...
<template>
	<section class="w-full flex items-center justify-center flex-col px-2 sm:px-8 transition-pad duration-300">
		<form
			...
			class="w-full md:w-[600px] px-2 pt-16 sm:pt-8 pb-4 flex flex-col items-center justify-center"
		>
				...
				<div class="input-field w-[94%] sm:w-[75%] flex flex-col justify-start gap-y-1.5 transition-width duration-300">
					...
					<div class="input w-full flex flex-row gap-x-1">
						...
						<input
							...
							v-model="login_formdata.MobileNumber"
							@input="validno = false"
						/>
					</div>
				...
				<div class="input-field w-[94%] sm:w-[75%] flex flex-col justify-start gap-y-1.5 transition-width duration-300">
					...
					<div class="input w-full relative flex items-center">
						<input
							...
							required
							v-model="login_formdata.password"
							@input="validpass = false"
						/>
			...
			<div class="submit-btn w-[94%] sm:w-[75%] pt-8 pb-4 flex items-center transition-width duration-300">
				<button
					type="submit"
					class="min-w-[9.2rem] px-12 py-2 text-lg font-bold tracking-wide text-slate-100 bg-orange-600 rounded hover:bg-orange-500 transition-colors duration-300 flex items-center justify-center"
				>
					<Transition name="slide" mode="out-in">
			...
			<div class="create-new w-[94%] sm:w-[75%] pt-6 sm:pt-4 pb-2 flex flex-row gap-x-2 items-center transition-width duration-300">
				...
				<router-link
					:to="{ name: 'Register' }"
					class="text-[#346974] font-bold font-sans hover:text-orange-500 transition-colors duration-300"
