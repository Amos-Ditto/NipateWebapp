<template>
    <section class="w-full pt-8 pb-12 md:pb-28 px-1 sm:px-[8px] lg:px-[80px] xl:px-[90px] 2xl:px-[115px] transition-pad duration-300">
       <main class="w-full grid grid-cols-5 gap-x-3">
        <nav class="hidden sm:flex col-span-1 bg-gray-100 py-2 flex-col gap-y-2">
        ...
        <div class="body col-span-5 sm:col-span-4 rounded-t flex flex-col pb-8 gap-y-3 text-[#346974]">
            <div class="hero-search flex flex-col gap-y-5 px-2.5 sm:px-5 py-0 rounded">
                <div class="search-bar flex flex-row w-full">
                    ...
                    <button
                        class="py-1.5 sm:py-2.5 px-3 sm:px-5 tracking-wider text-sm sm:text-base bg-orange-400 hover:bg-orange-500 focus:bg-orange-500 text-slate-100 rounded-r font-bold capitalize"
                    >search</button>
                </div>
                <div class="search-filter w-full sm:w-[90%] flex flex-col gap-y-1">
...
.search-bar input {
    @apply py-2.5 sm:py-2 px-4 w-[80%] border-gray-200 border border-r-0 rounded-l tracking-wider text-sm sm:text-base font-light bg-gray-50 outline-none focus:border-gray-300;
}

ul.nav-list li {
    @apply py-1 text-base font-bold tracking-wide border-b border-gray-200 flex flex-col;
}

ul.nav-list li button {
    @apply py-3  px-2 flex flex-row justify-between items-center w-full hover:bg-gray-200 ;
}
