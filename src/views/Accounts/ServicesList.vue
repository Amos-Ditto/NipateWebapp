...
<template>
	<section class="w-full flex flex-col gap-y-4 sm:gap-y-8 pb-16 px-1 sm:px-4 lg:px-12">
		<nav class="w-full flex flex-row items-center justify-between">
			...
			<div class="right-nav">
				<button
					class="bg-slate-700 hover:bg-slate-800 flex flex-row items-center gap-x-1.5 transition-colors capitalize text-slate-100 text-xs xs:text-sm font-light py-2 px-3 xs:px-4 rounded-2xl"
		...
		<div class="body-container w-full py-2 px-0 flex flex-col gap-y-8 text-[#346974]">
			...
			<div
				class="new-service w-full flex flex-col rounded-sm py-2 sm:py-4 px-4 gap-y-4 sm:gap-y-8 justify-center items-center border border-gray-300"
			>
				<div class="new-nav w-full flex flex-row justify-between items-center">
					...
					<div
						class="new-icon-link p-2 rounded-full border-none sm:border border-gray-300 hover:bg-gray-300 cursor-pointer transition-colors duration-300"
					>
				...
				<div class="new-text flex flex-col items-center justify-center gap-y-4">
					...
					<RouterLink
						:to="{ name: 'Provider-Services-New' }"
						class="uppercase border border-slate-400 hover:bg-slate-700 transition-colors duration-300 text-slate-600 hover:text-slate-100 font-light px-4 py-2 rounded-sm text-xs"
