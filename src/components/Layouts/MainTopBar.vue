	...
	<header class="w-full h-full flex flex-col bg-gray-50 relative">
		<div class="top-nav items-center">
			...
			<div class="account relative">
				<div
					class="account-btn pr-4 sm:pr-0 flex flex-row items-center gap-x-0.5 relative cursor-pointer"
				...
				<Transition name="pop-up">
					...
					>
						...
						<div
							class="user-client flex flex-row items-center gap-x-3 py-1.5 px-2 hover:bg-gray-100 cursor-pointer"
							@click="reDirectToUserAccount"
						>
							...
							<div class="user-details flex flex-col gap-y-0">
								<small class="text-sm text-slate-600"
									>{{ UserDetails.User.FirstName || "Anonymous" }} {{ UserDetails.User.SurName }}</small
								>
						...
						<div
							@click="redirectToRegisterProvider"
							class="register-provider text-slate-600 flex flex-row items-center gap-x-3 py-2 px-2 hover:bg-gray-100 cursor-pointer"
						>
...
.account-btn:hover small,
.account-btn:hover .i-mdi-account-outline {
