...
<template>
    <div class="w-full py-2 sm:py-5 flex flex-col justify-center items-center gap-y-12 sm:gap-y-16">
        <div class="hero-title flex w-full justify-center items-center">
            <h3
                class="text-center leading-[1.325] sm:leading-[1.25] text-3xl xs:text-5xl sm:text-5xl md:text-6xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-bl from-[#014451] to-[#1f7794] font-bold tracking-wide transition-font duration-300"
            >Find the best people <br class="" /> to serve you.</h3>
        </div>
        <div class="serch-container grid grid-cols-4 gap-x-2 sm:gap-x-5 w-[86%] sm:w-[65%] lg:w-[50%]">
